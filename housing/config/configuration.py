...
class Configuration():
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact'
            artifact_dir = self.training_pipeline_config.artifact_dir
            data_ingestion_artifact_dir = os.path.join(artifact_dir, DATA_INGESTION_ARTIFACT_DIR_NAME,
                                                       self.time_stamp) 
            # 'C:\Users\anjik\Desktop\iNeuron_FSDS\ML_end_to_end_projects\ML_project1\housing\artifact\data_ingestion\2023-02-10-17-01-52'
            ...
            logging.info(f"Data Ingestion Config is :{data_ingestion_config}")
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            data_validation_artifact_dir = os.path.join(artifact_dir, DATA_VALIDATION_ARTIFACT_DIR_NAME,
                                                       self.time_stamp)
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\data_validation\\2023-02-10-17-01-52'
            data_validation_config = self.config_info[DATA_VALIDATION_CONFIG_KEY]
            
            schema_file_path = os.path.join(ROOT_DIR, 
                                            data_validation_config[DATA_VALIDATION_SCHEMA_DIR_KEY],
                                            data_validation_config[DATA_VALIDATION_SCHEMA_FILE_NAME_KEY])
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\config\\schema.yaml
            
            report_file_path = os.path.join(data_validation_artifact_dir,
                                            data_validation_config[DATA_VALIDATION_REPORT_FILE_NAME_KEY])
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\data_validation\\2023-02-10-17-01-52\\report.json'
            report_page_file_path = os.path.join(data_validation_artifact_dir,
                                            data_validation_config[DATA_VALIDATION_REPORT_PAGE_FILE_NAME_KEY])
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\data_validation\\2023-02-10-17-01-52\\report.html'
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            data_transformation_artifact_dir = os.path.join(artifact_dir, 
                                                            ...
                                                            self.time_stamp)
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\data_transformation\\2023-02-10-17-01-52'
            ...
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\data_transformation\\2023-02-10-17-01-52\\transormed_data\\train'
            ...
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\data_transformation\\2023-02-10-17-01-52\\transormed_data\\test'
            ...
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\data_transformation\\2023-02-10-17-01-52\\preprocessed\\preprocessed.pkl'
            ...
            logging.info(f"Data Transformation Config is: {data_transformation_config}")
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            # 'C:\\Users\\anjik\\Desktop\\iNeuron_FSDS\\ML_end_to_end_projects\\ML_project1\\housing\\artifact\\model_trainer\\2023-02-10-17-01-52'
            ...
            # C:\Users\anjik\Desktop\iNeuron_FSDS\ML_end_to_end_projects\ML_project1\housing\artifact\model_trainer\2023-02-10-17-01-52\trained_model\model.pkl
            ...
            # C:\Users\anjik\Desktop\iNeuron_FSDS\ML_end_to_end_projects\ML_project1\config\model.yaml
            ...
            logging.info(f"Model Trainer Config is: {model_trainer_config}")
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            ...
            model_evaluation_artifact_dir = os.path.join(artifact_dir,
                                                         ...
                                                         ) # model_evaluation doesn't need timestamp
            # C:\Users\anjik\Desktop\iNeuron_FSDS\ML_end_to_end_projects\ML_project1\housing\artifact\model_evaluation
            model_evaluation_config = self.config_info[MODEL_EVALUATION_CONFIG_KEY]
            
            model_evaluation_file_path = os.path.join(model_evaluation_artifact_dir,
                                                      model_evaluation_config[MODEL_EVALUATION_FILE_NAME_KEY])
            # C:\Users\anjik\Desktop\iNeuron_FSDS\ML_end_to_end_projects\ML_project1\housing\artifact\model_evaluation\model_evaluation.yaml
            ...
            logging.info(f"Model Evaluation Config is:{model_evaluation_config}")
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            export_dir_path = os.path.join(ROOT_DIR, 
                                           ...
                                           time_stamp)
            # C:\Users\anjik\Desktop\iNeuron_FSDS\ML_end_to_end_projects\ML_project1\saved_models
            
            model_pusher_config = ModelPusherConfig(export_dir_path = export_dir_path)
            
            logging.info(f"Model Pusher Config is:{model_pusher_config}")
    ...
    def get_training_pipeline_config(self) -> TrainingPipelineConfig:
        try:
            ...
            logging.info(f"Training Pipeline Config is: {training_pipeline_config}")
